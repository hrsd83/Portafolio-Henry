...
const SocialLinks = () => {
  const linsksSocial = [
    ...
    },
    {
      ...
      href: "/public/Henry_dev.pdf",
      style: "rounded-br-md",
      download: "/public/Henry_dev.pdf",
    },
    {
      id: 4,
      child: (
      ...
      <ul>
        {linsksSocial.map(({ id, child, href, style, download }) => (
          <li
            key={id}
            className={
              "flex justify-between items-center w-40 h-14 px-4 bg-gradient-to-r from-cyan-950 to-black ml-[-100px] hover:ml-[-10px] hover:rounded-md duration-300 " +
              " " +
              style
            }
          >
